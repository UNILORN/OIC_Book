            ...
            <form class="search" action="/admin/order" method="GET">
                <div class="input-group">
                    ...
                    <input type="text" name="order_id" class="form-control"
                           value="{{ array_get($request,'order_id','') }}">
                </div>
                <div class="input-group">
                    <span class="input-group-addon">発注商品名</span>
                    <input type="text" name="product_name" class="form-control"
                           value="{{ array_get($request,'product_name','') }}">
                </div>
                <div class="input-group">
                    <span class="input-group-addon">担当従業員名</span>
                    <input type="text" name="employee_name" class="form-control"
                           value="{{ array_get($request,'employee_name','') }}">
                </div>
                <div class="input-group">
                    <span class="input-group-addon">発注日付</span>
                    <input type="date" name="order_day_from" class="form-control"
                           value="{{array_get($request,'order_day_from','') }}">
                    <span class="input-group-addon">〜</span>
                    <input type="date" name="order_day_to" class="form-control"
                           value="{{array_get($request,'order_day_to','') }}">
                </div>
                <div class="input-group">
                    <span class="input-group-addon">入荷予定日</span>
                    <input type="date" name="arrive_day_from" class="form-control"
                           value="{{array_get($request,'arrive_day_from','') }}">
                    <span class="input-group-addon">〜</span>
                    <input type="date" name="arrive_day_to" class="form-control"
                           value="{{array_get($request,'arrive_day_to','') }}">
                </div>
